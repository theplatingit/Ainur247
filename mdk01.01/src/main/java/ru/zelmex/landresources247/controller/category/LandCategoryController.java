...
public class LandCategoryController {
    ...
    void addCategory(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(LandResourcesApplication.class.getResource("add-edit-land-category-dialog.fxml"));
    ...
    void btnPlotsOnAction(ActionEvent event) {
        LandResourcesApplication.primaryStage.setScene(LandResourcesApplication.landPlots);
    }
    @FXML
